function [Priors, Mu, Sigma] = EM_init_kmeans(Data, nbStates, k_centers)
%
...
% added by luotao:
% k_centers: the initial kmeans center

[nbVar, nbData] = size(Data);

%Use of the 'kmeans' function from the MATLAB Statistics toolbox
if(exist('k_centers', 'var'))
    [Data_id, Centers] = kmeans(Data', nbStates,'emptyaction','singleton','start',k_centers);
else
